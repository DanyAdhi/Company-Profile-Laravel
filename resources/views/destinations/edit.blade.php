...
@section('breadcrumbs', 'Edit Destination')
                    ...
                    <form action="{{route('destinations.update', [$destination->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-10">
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" placeholder="Destination Title..." class="form-control {{$errors->first('title') ? "is-invalid" : ""}}" value="{{$destination->title}}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="content" class="form-control ckeditor" name="content" rows="10" cols="50">{{$destination->content}}</textarea>
                            </div>
                            <div class="mb-3 mt-4">
